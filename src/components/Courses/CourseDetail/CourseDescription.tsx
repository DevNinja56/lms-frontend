    ...
    <>
      <div className="mr-1 w-11/12 ml-14">
        <p className="font-medium text-lg pt-24 pb-8">Description</p>
          ...
          <p className={`pb-8 text-mainParaColor description-content transition-opacity ${showMore ? 'opacity-100' : 'opacity-50'}` }>
            ...
            too! First, we will go over the differences between UX and UI
            Design. We will look at what our brief for this real-world project
            is, then we will learn about low-fidelity wireframes and how to make
