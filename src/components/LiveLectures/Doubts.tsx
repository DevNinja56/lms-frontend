...
const Doubts = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white px-3 py-12 md:p-3 rounded-md shadow-md shadow-gray-300">
        <div className="flex flex-col items-center gap-5">
          <h2 className="text-xl md:text-2xl text-center font-semibold text-mainParaColor">
