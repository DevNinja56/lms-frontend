...
const Home = () => {
 ...
 <img
  className={`absolute left-[40px] lg:left-[80px] top-[153px] ${hoverAnimationOnStar && 'animate-slowBounce'}`}
  src={starImg}
  onMouseEnter={() => setHoverAnimationOnStar(true)}
/>
<img
  className={`absolute right-[140px] lg:right-[220px] top-[50px] ${hoverAnimationOnRocket && 'animate-slowBounce'}`}
  src={rocketImg}
  onMouseEnter={() => setHoverAnimationOnRocket(true)}
/>
<img
  className={`absolute right-[50px] lg:right-[80px] top-[294px] ${hoverAnimationOnPaper && 'animate-slowBounce'}`}
  src={paperImg}
