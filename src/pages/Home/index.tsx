...
const Home = () => {
  ...
  const [
    hoverAnimationOnStar,
    setHoverAnimationOnStar,
  ] = useState(false);
  const [
    hoverAnimationOnRocket,
    setHoverAnimationOnRocket,
  ] = useState(false);
  const [
    hoverAnimationOnPaper,
    setHoverAnimationOnPaper,
  ] = useState(false);
  ...
  return (
    <div className="flex flex-col gap-8 items-center pb-10 relative max-w-[1142px] mx-auto px-2">
      ...
      <img
        ...
        src={rocketImg}
        onMouseEnter={() =>
          setHoverAnimationOnRocket(true)
        }
      />
      <img
