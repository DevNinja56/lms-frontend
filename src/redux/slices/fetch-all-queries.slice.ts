  ...
  endpoints: (builder) => ({
    ...
    >({
      query: (courseId: string) => ({
        url: API_ENDPOINTS.COURSE_BY_ID.replace(
          ":id",
          courseId
        ),
      }),
    ...
    >({
      query: (courseId: string) => ({
        url: API_ENDPOINTS.SUBJECT.replace(
          ":id",
          courseId
        ),
      }),
